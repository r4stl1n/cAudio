...
class cAudioCSharpWrapperPINVOKE {
  ...
  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioManager_getAvailableDeviceName")]
  public static extern string IAudioManager_getAvailableDeviceName(HandleRef jarg1, uint jarg2);

  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioManager_getAvailableDeviceCount")]
  public static extern uint IAudioManager_getAvailableDeviceCount(HandleRef jarg1);

  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioManager_getDefaultDeviceName")]
  public static extern string IAudioManager_getDefaultDeviceName(HandleRef jarg1);
  ...
  public static extern IntPtr IAudioManager_createFromRaw(HandleRef jarg1, string jarg2, string jarg3, uint jarg4, uint jarg5, HandleRef jarg6);
  ...
  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioSource_release")]
  public static extern void IAudioSource_release(HandleRef jarg1);
  ...
  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioSource_setMaxDistance")]
  public static extern void IAudioSource_setMaxDistance(HandleRef jarg1, float jarg2);
  ...
  public static extern IntPtr ILogger_getLogLevel(HandleRef jarg1);

  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_ILogger_setLogLevel")]
  public static extern void ILogger_setLogLevel(HandleRef jarg1, HandleRef jarg2);
  ...
  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioCapture_isSupported")]
  public static extern bool IAudioCapture_isSupported(HandleRef jarg1);
  ...
  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioCapture_getAvailableDeviceName")]
  public static extern string IAudioCapture_getAvailableDeviceName(HandleRef jarg1, uint jarg2);

  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioCapture_getAvailableDeviceCount")]
  public static extern uint IAudioCapture_getAvailableDeviceCount(HandleRef jarg1);

  [DllImport("cAudioCSharpWrapper", EntryPoint="CSharp_IAudioCapture_getDefaultDeviceName")]
  public static extern string IAudioCapture_getDefaultDeviceName(HandleRef jarg1);
